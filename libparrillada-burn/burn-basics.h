...
#define PARRILLADA_BURN_TMP_FILE_NAME		"parrillada_tmp_XXXXXX"

#define PARRILLADA_MD5_FILE			".checksum.md5"
#define PARRILLADA_SHA1_FILE			".checksum.sha1"
#define PARRILLADA_SHA256_FILE			".checksum.sha256"

#define PARRILLADA_BURN_FLAG_ALL 0xFFFF
