...
static gboolean
parrillada_multi_DND_row_draggable (EggTreeMultiDragSource *drag_source,
				 GList *path_list)
{
	GList *iter;
...
static gboolean
parrillada_multi_DND_drag_data_get (EggTreeMultiDragSource *drag_source, 
				 GList *path_list, 
...
static gboolean
parrillada_multi_DND_drag_data_delete (EggTreeMultiDragSource *drag_source,
				    GList *path_list)
{
	return TRUE;
}
...
static void
parrillada_multi_DND_drag_source_init (EggTreeMultiDragSourceIface *iface)
{
	iface->row_draggable = parrillada_multi_DND_row_draggable;
	iface->drag_data_get = parrillada_multi_DND_drag_data_get;
	iface->drag_data_delete = parrillada_multi_DND_drag_data_delete;
}

static const GInterfaceInfo multi_DND_drag_source_info = {
	(GInterfaceInitFunc) parrillada_multi_DND_drag_source_init,
	NULL,
	NULL
};

static gboolean
parrillada_data_track_cfg_multi_DND_row_draggable (EggTreeMultiDragSource *drag_source,
						GList *path_list)
{
	GList *iter;
...
static gboolean
parrillada_data_track_cfg_multi_DND_drag_data_get (EggTreeMultiDragSource *drag_source,
						GList *path_list,
						GtkSelectionData *selection_data)
{
...
static gboolean
parrillada_data_track_cfg_multi_DND_drag_data_delete (EggTreeMultiDragSource *drag_source,
						   GList *path_list)
{
...
static void
parrillada_data_track_cfg_multi_DND_drag_source_init (EggTreeMultiDragSourceIface *iface)
{
	iface->row_draggable = parrillada_data_track_cfg_multi_DND_row_draggable;
	iface->drag_data_get = parrillada_data_track_cfg_multi_DND_drag_data_get;
	iface->drag_data_delete = parrillada_data_track_cfg_multi_DND_drag_data_delete;
}

static const GInterfaceInfo parrillada_data_track_cfg_multi_DND_drag_source_info = {
	(GInterfaceInitFunc) parrillada_data_track_cfg_multi_DND_drag_source_init,
	NULL,
	NULL
};

gboolean
parrillada_enable_multi_DND_for_model_type (GType type)
{
...
void
parrillada_enable_multi_DND (void)
{
	...
	g_type_add_interface_static (GTK_TYPE_LIST_STORE,
				     EGG_TYPE_TREE_MULTI_DRAG_SOURCE,
				     &multi_DND_drag_source_info);
	g_type_add_interface_static (PARRILLADA_TYPE_TRACK_DATA_CFG,
				     EGG_TYPE_TREE_MULTI_DRAG_SOURCE,
				     &parrillada_data_track_cfg_multi_DND_drag_source_info);
}
