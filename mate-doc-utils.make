...
_chunks  ?= `$(PKG_CONFIG) --variable xmldir mate-doc-utils`/gnome/xslt/docbook/utils/chunks.xsl
_credits ?= `$(PKG_CONFIG) --variable xmldir mate-doc-utils`/gnome/xslt/docbook/utils/credits.xsl
_ids ?= `$(PKG_CONFIG) --variable xmldir mate-doc-utils`/gnome/xslt/docbook/utils/ids.xsl
