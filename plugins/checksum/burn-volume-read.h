...
#ifndef _PARRILLADA_MEDIUM_HANDLE_H
#define PARRILLADA_MEDIUM_HANDLE_H
...
typedef struct _ParrilladaVolFileHandle ParrilladaVolFileHandle;
...
#endif /* PARRILLADA_MEDIUM_HANDLE_H */
