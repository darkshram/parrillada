...
typedef enum {
	PARRILLADA_JACKET_IMAGE_NONE	= 0,
	PARRILLADA_JACKET_IMAGE_CENTER	= 1,
	PARRILLADA_JACKET_IMAGE_TILE,
	PARRILLADA_JACKET_IMAGE_STRETCH
} ParrilladaJacketImageStyle;

typedef enum {
	PARRILLADA_JACKET_COLOR_NONE	= 0,
	PARRILLADA_JACKET_COLOR_SOLID	= 1,
	PARRILLADA_JACKET_COLOR_HGRADIENT,
	PARRILLADA_JACKET_COLOR_VGRADIENT
