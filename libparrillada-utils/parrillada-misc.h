...
#ifndef _PARRILLADA_MISC_H
#define _PARRILLADA_MISC_H

G_BEGIN_DECLS

GQuark parrillada_utils_error_quark (void);

#define PARRILLADA_UTILS_ERROR				parrillada_utils_error_quark()

typedef enum {
	PARRILLADA_UTILS_ERROR_NONE,
...
#define PARRILLADA_GET_BASENAME_FOR_DISPLAY(uri, name)				\
{										\
...
GtkWidget *
parrillada_utils_properties_get_label (GtkWidget *widget);
