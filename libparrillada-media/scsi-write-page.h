...
struct _ParrilladaScsiWritePage {
	uchar code		:6;
	uchar reserved		:1;
	uchar ps		:1;
...
typedef struct _ParrilladaScsiWritePage ParrilladaScsiWritePage;

typedef enum {
	PARRILLADA_SCSI_WRITE_PACKET_INC	= 0x00,
	PARRILLADA_SCSI_WRITE_TAO		= 0x01,
	PARRILLADA_SCSI_WRITE_SAO		= 0x02,
	PARRILLADA_SCSI_WRITE_RAW		= 0x03

	/* Reserved */
} ParrilladaScsiWriteMode;
