...
typedef struct _ParrilladaScsiStatusWrSpdDesc ParrilladaScsiStatusWrSpdDesc;

#if G_BYTE_ORDER == G_LITTLE_ENDIAN

struct _ParrilladaScsiStatusWrSpdDesc {
	uchar reserved0			:8;
...
struct _ParrilladaScsiStatusPage {
	uchar code			:6;			/* 0 */
	uchar reserved0			:1;
	uchar ps			:1;
	...
	ParrilladaScsiStatusWrSpdDesc wr_spd_desc [0];		/* 32 */
};
...
typedef struct _ParrilladaScsiStatusPage ParrilladaScsiStatusPage;
