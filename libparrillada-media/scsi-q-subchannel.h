...
typedef enum {
PARRILLADA_SCSI_Q_SUB_CHANNEL_NO_MODE		= 0x00,
PARRILLADA_SCSI_Q_SUB_CHANNEL_CURRENT_POSITION	= 0x01,

/* Media Catalog Number */
PARRILLADA_SCSI_Q_SUB_CHANNEL_MCN			= 0x02,

/* International Standard Recording Code */ 
PARRILLADA_SCSI_Q_SUB_CHANNEL_ISRC			= 0x03,
} ParrilladaScsiQSubChannelMode;
 ...
 */
PARRILLADA_SCSI_Q_SUB_CHANNEL_TRACK_START			= 0x63,
 ...
 * PFRAME = 0
 */
PARRILLADA_SCSI_Q_SUB_CHANNEL_FIRST_TRACK_NUM_DATA_FORMAT	= 0xA0,

/* MIN, SEC, FRAME = time in leadin
 * PMIN = track num of last track in program area (BCD)
 * PSEC, PFRAME = 0
 */
PARRILLADA_SCSI_Q_SUB_CHANNEL_LAST_TRACK_NUM		= 0xA1,

/* MIN, SEC, FRAME = time in leadin
 * PMIN, PSEC, PFRAME = start time of leadout (BCD)
 */
PARRILLADA_SCSI_Q_SUB_CHANNEL_LEADOUT_START		= 0xA2,
} ParrilladaScsiQSubChannelLeadinMode1;
 ...
 */
PARRILLADA_SCSI_Q_SUB_CHANNEL_MULTI_NEXT_SESSION		= 0xB0,

/* MIN, SEC, FRAME = ATIP special informations
 * ZERO = 0
 * PMIN, PSEC, PFRAME = start time of the first leadin
 */
PARRILLADA_SCSI_Q_SUB_CHANNEL_MULTI_FIRST_LEADIN		= 0xC0,

/* Audio only */
PARRILLADA_SCSI_Q_SUB_CHANNEL_PLAYBACK_SKIPS_1_40		= 0x28,

PARRILLADA_SCSI_Q_SUB_CHANNEL_SKIP_INTERVALS		= 0xB1,
PARRILLADA_SCSI_Q_SUB_CHANNEL_SKIP_TRACK_1			= 0xB2,
PARRILLADA_SCSI_Q_SUB_CHANNEL_SKIP_TRACK_2			= 0xB3,
PARRILLADA_SCSI_Q_SUB_CHANNEL_SKIP_TRACK_3			= 0xB4
} ParrilladaScsiQSubChannelLeadinMode5;


/* NOTE: the real meaning of the following values is
 * determined by point member see above */
typedef enum {
PARRILLADA_SCSI_Q_SUB_CHANNEL_LEADIN_NO_MODE	= 0x00,
PARRILLADA_SCSI_Q_SUB_CHANNEL_LEADIN_MODE1		= 0x01,
PARRILLADA_SCSI_Q_SUB_CHANNEL_LEADIN_MODE2		= 0x01,
PARRILLADA_SCSI_Q_SUB_CHANNEL_LEADIN_MODE5		= 0x05
} ParrilladaScsiQSubChannelLeadinMode;
 ...
 */
PARRILLADA_SCSI_Q_SUB_CHANNEL_PMA_TOC		= 0x01,
 ...
 * PFRAME          = 00
 */
PARRILLADA_SCSI_Q_SUB_CHANNEL_PMA_DISC_ID		= 0x02,
 ...
 * PMIN, PSEC, PFRAME
 */
PARRILLADA_SCSI_Q_SUB_CHANNEL_PMA_SKIP_TRACK	= 0x03,
 ...
 * PMIN, PSEC, PFRAME
 */
PARRILLADA_SCSI_Q_SUB_CHANNEL_PMA_UNSKIP		= 0x04,
 ...
 */
PARRILLADA_SCSI_Q_SUB_CHANNEL_PMA_SKIP_INTERVAL	= 0x05,
 ...
 */
PARRILLADA_SCSI_Q_SUB_CHANNEL_PMA_UNSKIP_INTERVAL	= 0x06,
} ParrilladaScsiQSubChannelPmaMode;

/* This is usually the control field in structures related to Q Sub-Channel */
typedef enum {
PARRILLADA_SCSI_TRACK_AUDIO			= 0x00,
PARRILLADA_SCSI_TRACK_PREEMP			= 0x01,
PARRILLADA_SCSI_TRACK_4_CHANNELS			= 0x08,

PARRILLADA_SCSI_TRACK_DATA				= 0x04,
PARRILLADA_SCSI_TRACK_DATA_INCREMENTAL		= 0x01,

PARRILLADA_SCSI_TRACK_COPY				= 0x02,

} ParrilladaScsiTrackMode;
