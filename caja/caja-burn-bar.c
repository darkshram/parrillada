...
G_DEFINE_TYPE (CajaDiscBurnBar, caja_disc_burn_bar, GTK_TYPE_BOX)
...
caja_disc_burn_bar_class_init (CajaDiscBurnBarClass *klass)
{
        ...
        signals [TITLE_CHANGED] = g_signal_new ("title_changed",
                                                ...
                                                G_SIGNAL_RUN_LAST,
                                                G_STRUCT_OFFSET (CajaDiscBurnBarClass, title_changed),
                                                NULL, NULL,
        ...
        signals [ICON_CHANGED] = g_signal_new ("icon_changed",
                                               G_TYPE_FROM_CLASS (klass),
                                               G_SIGNAL_RUN_LAST,
                                               G_STRUCT_OFFSET (CajaDiscBurnBarClass, icon_changed),
                                               NULL, NULL,
                                               g_cclosure_marshal_VOID__VOID,
                                               G_TYPE_NONE, 0);
...
static void
caja_disc_burn_bar_title_changed (GtkEditable *editable,
                                      CajaDiscBurnBar *bar)
{
	g_signal_emit (bar,
...
static void
caja_disc_burn_bar_icon_button_clicked (GtkEntry *entry,
                                            ...
                                            CajaDiscBurnBar *bar)
{
	...
	gtk_widget_destroy (chooser);
        ...
        caja_disc_burn_bar_set_icon (bar, path);
        g_free (path);
...
static void
caja_disc_burn_bar_title_insert_text (GtkEditable *editable,
                                          const gchar *text,
                                          gint length,
                                          gint *position,
                                          CajaDiscBurnBar *bar)
{
	...
	*current = '\0';
	g_signal_handlers_block_by_func (editable,
					 (gpointer) caja_disc_burn_bar_title_insert_text,
					 bar);
...
caja_disc_burn_bar_init (CajaDiscBurnBar *bar)
{
        ...
        g_signal_connect (entry,
			  "icon-release",
			  G_CALLBACK (caja_disc_burn_bar_icon_button_clicked),
			  bar);
	g_signal_connect (entry,
			  "insert_text",
			  G_CALLBACK (caja_disc_burn_bar_title_insert_text),
			  bar);
	g_signal_connect (entry,
			  "changed",
			  G_CALLBACK (caja_disc_burn_bar_title_changed),
			  bar);
